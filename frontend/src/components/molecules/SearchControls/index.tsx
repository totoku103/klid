...
/**
 * SearchTextInput - 검색 조건용 텍스트 input
 * (molecules/SearchInput과 구분하기 위해 이름 변경)
 */
export interface SearchTextInputProps extends InputHTMLAttributes<HTMLInputElement> {
...
export const SearchTextInput = forwardRef<HTMLInputElement, SearchTextInputProps>(
